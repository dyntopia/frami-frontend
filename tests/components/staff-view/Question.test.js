...
import { View } from '../../../src/components/staff-view/question';
...
describe('question', () => {
  test('list', async () => {
    ...
    const wrapper = mount(
      <APIContext.Provider value={() => promise}>
        <MemoryRouter initialEntries={['/patient/1/question/']}>
          <Routes user={{ id: 1 }}>
            <View />
          </Routes>
        </MemoryRouter>
  ...
  test('add', () => {
    ...
    const wrapper = mount(
      <MemoryRouter initialEntries={['/patient/1/question/add/']}>
        <Routes user={{ id: 1 }}>
          <View />
        </Routes>
      </MemoryRouter>
  ...
  test('show', async () => {
    ...
    const wrapper = mount(
      <APIContext.Provider value={() => promise}>
        <MemoryRouter initialEntries={['/patient/1/question/1/']}>
          <Routes user={{ id: 1 }}>
            <View />
          </Routes>
        </MemoryRouter>
